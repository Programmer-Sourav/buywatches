...
import { createOrder } from "../Utils/NetworkApis";
export default function Success(){
   const { priceDetails } = useContext(ProductsContext)

    const makePayment = () =>{
       createOrder(priceDetails.price)
       const amount = priceDetails.price*100;
        var options = {
    ...
    return(
        <div>
            {/* <h1>Your order has been placed successfully... It will be delivered soon!</h1> */}
